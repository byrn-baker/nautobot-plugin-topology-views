...
from django.conf import settings
from nautobot.forms import NetBoxModelFilterSetForm, NetBoxModelForm, NetBoxModelImportForm
...
class DeviceFilterForm(
    ...
    save_coords = forms.BooleanField(
        ...
        required=False,
        disabled=(not settings.PLUGINS_CONFIG['nautobot_topology_views']['allow_coordinates_saving'] or settings.PLUGINS_CONFIG['nautobot_topology_views']['always_save_coordinates']),
